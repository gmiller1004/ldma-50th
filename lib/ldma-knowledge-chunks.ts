...
export const LDMA_KNOWLEDGE_CHUNKS: KnowledgeChunk[] = [
  ...
  },
  {
    ...
    title: "2026 Axiom Lite lifetime membership bundle",
    source: "/memberships",
    content: `The current Memberships page presents a single offer: LDMA Lifetime with Garrett Axiom Lite. It includes LDMA Lifetime, GPAA Lifetime, Companion, Transferability, Pre-Paid Transfer, and the Garrett Axiom Lite detector. Live Shopify pricing is $2,899 versus a combined retail comparison of $11,798. Axiom Lite manufacturer retail is $2,299. It is a pulse-induction gold detector: Ultra-Pulse PI, Terra-Scan dual-channel ground balance, 4.2 lb with the included 11-inch coil, carbon fiber shaft collapsing 61.5" to 25", built-in Li-ion power around 16 hours with USB-C, integrated Z-Lynk wireless, 11x7" mono coil, rainproof control box, 3-year warranty, made in the USA. Through September 30, new LDMA memberships include The Founder Bag free during the GPAA SeptMember $250,000 Gold Giveaway (August 26 – September 30). The Founder Bag is a commemorative paydirt bag in memory of GPAA founder George "Buzzard" Massie. It cannot be purchased separately. It is only a gift with new LDMA memberships on myldma.com and GPAA Lifetime memberships at gpaalifetime.com. Each day of the giveaway, one Founder Bag includes a bonus mystery gold nugget. There is a 30-day cancellation policy and a $120 annual maintenance fee after the first year. Contract is sent after purchase for signature before final activation. Call 888-465-3717 with questions.`,
  },
  {
    ...
    source: "/memberships",
    content: `The /memberships route supports two experiences: a legacy memberships page and the current bundle page. The app can be toggled by environment variable NEXT_PUBLIC_MEMBERSHIP_EXPERIENCE. Setting it to legacy shows the older customize-your-membership page; setting to bundle (or leaving unset) shows the current single-offer Garrett Axiom Lite Lifetime bundle page.`,
  },
  {

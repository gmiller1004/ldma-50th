...
export type MemberLookupResult = {
  ...
  isLdmaAdmin?: boolean;
  /** When true, member can access caretaker portal (camp-scoped ops). */
  isCaretaker?: boolean;
  /** When true, member sees multi-camp caretaker admin dashboard (read-only). */
  isCaretakerAdmin?: boolean;
